...
import com.itrip.itripbiz.service.comment.ItripCommentService;
import com.itrip.itripbiz.service.hotel.ItripHotelService;
import com.itrip.itripbiz.service.image.ItripImageService;
import com.itrip.itripbiz.service.labeldic.ItripLabelDicService;
...
public class SystemCommentController {
    ...
    public Dto<Object> getHotelScore(@ApiParam(required = true, name = "hotelId", value = "酒店ID")
        ...
        log.debug("getHotelScore hotelId : " + hotelId);
...
/*	public Dto<Object> delPic(
	...
	public Dto<Object> getImgByTargetId(@ApiParam(required = true, name = "targetId", value = "评论ID")
		...
		Dto<Object> dto = new Dto<Object>();
		log.debug("getImgBytargetId targetId : " + targetId);
	...
	public Dto<Object> getCommentList(@RequestBody ItripSearchCommentVO itripSearchCommentVO){
		...
		log.debug("hotelId : " + itripSearchCommentVO.getHotelId());
		log.debug("isHavingImg : " + itripSearchCommentVO.getIsHavingImg());
		log.debug("isOk : " + itripSearchCommentVO.getIsOk());
